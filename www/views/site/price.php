<div class="b-price">
	<div class="container">
		...
		<nav class="b-price__tabs">
			<?php if ($GLOBALS['nav']) : foreach ($GLOBALS['nav'] as $item) : if($item['module'] != 'portfolio') continue;
		...
		<div class="b-price__table">
			<table>
				...
				<?php if ($GLOBALS['price']) : foreach ($GLOBALS['price'] as $item) : ?>
		...
		<form action="" method="POST" class="b-price__form">
			<fieldset>
